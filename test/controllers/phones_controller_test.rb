...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { description: @phone.description, image_url: @phone.image_url, make: @phone.make, model: @phone.model, price: @phone.price } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { description: @phone.description, image_url: @phone.image_url, make: @phone.make, model: @phone.model, price: @phone.price } }
